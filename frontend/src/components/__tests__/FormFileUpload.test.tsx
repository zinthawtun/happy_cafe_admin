...
import FormFileUpload from "@components/form-file-upload-component";
...
describe("FormFileUpload_Test", () => {
  ...
  it("calls onChange with null when file exceeds maxSize", () => {
    ...
    const largeMockFile = new File(["a".repeat(maxSize + 100)], "large.png", {
      type: "image/png",
    });
  ...
  it("displays error message when error is true", () => {
    ...
    expect(screen.getByRole("button", { name: /upload/i })).toHaveClass(
